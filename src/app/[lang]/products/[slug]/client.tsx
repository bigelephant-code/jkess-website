...
const reviews = [
  { name: 'Marco Rossi', date: '2026-05-28', rating: 5, variant: '16S 48V 200A', content: 'Excellent BMS board. Installation was straightforward and the Bluetooth monitoring app works perfectly.' },
  { name: 'Klaus Müller', date: '2026-05-15', rating: 5, variant: '15KWh Kit', content: 'The battery kit arrived well-packaged and earlier than expected. Everything was included as described.' },
  { name: 'Jean-Pierre Dubois', date: '2026-04-22', rating: 4, variant: '16S 48V 300A', content: 'Solid product for the price. The active balancing works well. Would be nice to have a longer cable for the LCD display.' },
  { name: 'David Chen', date: '2026-04-10', rating: 5, variant: '16KWh Kit', content: 'Used this for my home solar backup system. The IP54 enclosure is perfect for outdoor installation.' },
]
