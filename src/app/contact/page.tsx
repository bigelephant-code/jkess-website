  ...
  const contactItems = [
    {
      icon: Phone,
      label: 'Phone',
      value: '+86 131 6282 8868',
      href: 'tel:+8613162828868',
      color: '#22c55e',
    },
    {
      icon: Mail,
      label: 'Email',
      value: 'chinaenergymall@163.com',
      href: 'mailto:chinaenergymall@163.com',
      color: '#5b5bff',
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Building B4, Guangming, Shenzhen',
      color: '#f58a8a',
    },
  ]
      ...
      <section className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(circle at 25% 50%, #22c55e 0%, transparent 50%), radial-gradient(circle at 75% 50%, #5b5bff 0%, transparent 50%)',
            }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-28 text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto">
              Have a project in mind? Need a custom quote? Our team is ready to help you
              find the perfect energy storage solution.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {contactItems.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  {item.href ? (
                    <a href={item.href} className="text-gray-900 font-semibold hover:text-green-600 transition-colors">
                      {item.value}
                    </a>
                  ) : (
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white font-semibold px-6 py-3 rounded-lg transition-all text-sm"
                >
            ...
            >
              ...
              <p className="text-gray-500 text-sm mb-5">
                Quickest way to get a response. Scan the QR code or tap the button below.
              </p>
