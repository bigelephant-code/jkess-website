      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white">Technical Specifications</h2>
          </div>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-1 h-6 bg-green-400 rounded-full" />
            <h2 className="text-xl md:text-2xl font-bold text-white">Product Details</h2>
          </div>
