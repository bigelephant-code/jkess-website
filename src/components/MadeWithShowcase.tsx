...
export default function MadeWithShowcase() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-gray-50 pb-2">
      <div
        ref={containerRef}
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 bottom-0 z-30 h-8 bg-gray-50" />
    </section>
  )
}
