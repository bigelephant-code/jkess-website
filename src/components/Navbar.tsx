...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-green-900/40 via-green-900/10 to-transparent backdrop-blur-xl border-b border-white/5">
